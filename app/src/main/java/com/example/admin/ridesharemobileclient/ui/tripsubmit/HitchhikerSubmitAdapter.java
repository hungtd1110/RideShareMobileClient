...
public class HitchhikerSubmitAdapter extends RecyclerView.Adapter<HitchhikerSubmitAdapter.ViewHolder> {
    ...
    HitchhikerSubmitAdapter(Context context, CallBack callBack) {
        mContext = context;
        mCallBack = callBack;
