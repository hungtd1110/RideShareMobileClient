...
public class ItemDriverBinder extends ItemViewBinder<Driver, ItemDriverBinder.ViewHolder> {
    private Context mContext;
    private SimpleDateFormat mDateFormat = new SimpleDateFormat("dd/MM/yyyy");

    public ItemDriverBinder(Context context) {
        mContext = context;
    }
    ...
    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, @NonNull Driver item) {
        holder.mItem = item;
