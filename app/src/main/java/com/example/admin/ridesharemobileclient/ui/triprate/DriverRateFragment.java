...
public class DriverRateFragment extends Fragment {
    ...
    private DriverRateAdapter adapter;
    private int page, size, visibleThreshold;
    private boolean isLoading;

    private static final String TAG = "DriverRateFragment";
...
//        });
    ...
    private void init() {
        try {
            ...
            adapter = new DriverRateAdapter(getContext(), new DriverRateAdapter.CallBack() {
                @Override
    ...
    private void showListDriver(String action) {
        try {
            Call<BaseRespone> call = mIAPIHelper.getListDriverRate(App.sToken);
